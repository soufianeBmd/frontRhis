  ...
  exportExcel() {
    ...
    const exportData: Partial<TableElement>[] =
      this.dataSource.filteredData.map((x) => ({
        'Employee': x.employee.nom,
        Date_d: formatDate(new Date(x.dateDebut), 'yyyy-MM-dd', 'en') || '',
        Date_f: formatDate(new Date(x.dateFin), 'yyyy-MM-dd', 'en') || '',
        Type: x.type,
      }));
    ...
    return data.sort((a, b) => {
      ...
      switch (this._sort.active) {
        case 'id':
          ...
          break;
        case 'employee':
          [propertyA, propertyB] = [a.employee.nom, b.employee.nom];
          break;
      }
